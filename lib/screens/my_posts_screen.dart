...
class _PostList extends StatelessWidget {
  ...
  const _PostList(
      {required this.posts, required this.emptyMsg, required this.onAction});
      ...
      child: ListView.builder(
        ...
        itemBuilder: (ctx, i) => Padding(
          ...
          child: _MyPostCard(
            post: posts[i],
            onTap: () =>
                Navigator.pushNamed(ctx, '/post-detail', arguments: posts[i])
                    .then((_) => onAction()),
            onStatusChange: (status) async {
              final updated = posts[i].copyWith(status: status);
...
class _MyPostCard extends StatelessWidget {
  ...
  const _MyPostCard(
      {required this.post, required this.onTap, required this.onStatusChange});
